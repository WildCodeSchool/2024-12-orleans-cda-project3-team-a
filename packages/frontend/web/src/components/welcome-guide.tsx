  ...
  return isLoading ? (
    ...
    >
      <div className='text-secondary-blue flex flex-col gap-3'>
        ...
        <p className='whitespace-wrap md:animate-typing5 md:flex md:w-0 md:overflow-hidden md:whitespace-nowrap'>{` You'll need to buyat least one creature of each species into your park.`}</p>
